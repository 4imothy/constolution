...
from block_try import EarlyBlock
...
def train(model, epochs = 10):
    ...
    with open("model_metrics_noW.csv", mode="w", newline="") as csvfile:
    ...
    pd.DataFrame(data).to_csv('model_vgg_base_noW.csv', index=False)
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), "model_vgg_base_noW.pth")
